...
* Removed 'Game Manuals' download functionality for the time being (this will be re-implemented in a future release). You can still manually add manuals to each game data folder though
